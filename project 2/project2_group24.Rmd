...
```{r, echo=TRUE, eval=TRUE}
yhat.boost = predict(boost.cv, newdata = college.test, n.trees=100)
...
dat.test = data.frame(x = d.test[, 1:length(dat.train)], y = d.test$diabetes)
...
rownames(GeneData) = paste(rep("G", 1000), c(1:1000), sep = "")
