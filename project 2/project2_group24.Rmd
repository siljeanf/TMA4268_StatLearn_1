...
%%Check if log scale!!
From cross validation we can observe that the optimal tuning parameter is $\lambda = 5.093201$ as this is the parameter that minimizes the MSE for the training set. 
