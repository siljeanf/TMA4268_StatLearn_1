...
```
**(iii)** The test MSE using $M=4$ PCs is **`r MSE_pls`**. Compared to the test MSE for ridge regression **`r MSE_ridge`**, PLS regression seems to be even better model choice for prediction as its test MSE is a bit lower.
